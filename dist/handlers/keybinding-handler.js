...
export class KeybindingHandler {
    ...
    async updateKeybindings(args) {
        // WARNING: This method should never be used
        throw new Error('⚠️ KEYBINDING MODIFICATION PROHIBITED!\n\n' +
    ...
    extractKeybindings(content, mode, plugin) {
    ...
    generateKeybindingsContent(newKeybindings, currentContent) {
