...
`;
    ...
    async exportConfig(args) {
        ...
        try {
            ...
            await fs.writeFile(path.join(outputPath, 'export-manifest.json'), JSON.stringify(manifest, null, 2));
            return {
                content: [
                    {
                        type: 'text',
    ...
    async getDefaultConfigPath(configType) {
    ...
    async applyFeatureCustomizations(targetPath, features) {
